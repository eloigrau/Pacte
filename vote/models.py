...
from pacte.models import Profil, Asso
...
class SuffrageBase(models.Model):
    ...
    estPublic = models.BooleanField(default=False, verbose_name="Vote public")
...
class Suffrage(SuffrageBase):
    ...
    def save(self, userProfile=None, *args, **kwargs):
        ...
        if not self.id:
            ...
            titre = "Nouveau vote"
            message = userProfile.username + " a lancé un nouveau vote ["+ str(self.estPublic) +"]: '<a href='https://www.perma.cat"+ self.get_absolute_url() + "'>"+ self.titre + "</a>'"
